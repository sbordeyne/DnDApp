...
class CharacterSheetTab(Frame):
    def __init__(self,master=None):
        ...
        self.remainingLabel=Label(self,textvariable=self.remainingXP,relief=SUNKEN,width=5)
        self.remainingLabel.grid(row=8,column=1)
        self.bonusLabel=Label(self,textvariable=self.bonusXP,relief=SUNKEN,width=5)
