...
[ ] slightly improve character Sheet interface with some padding, and add a Text Widget to keep track of treasures and inventory, maybe add a button to roll caracteristics.
...
from diceTab import *
from encounterTab import *
from mapTab import *
from treasureTab import *
from diseaseTab import *
